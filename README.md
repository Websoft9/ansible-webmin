...
To learn more information, please view [Installation & Configuration](https://www.webmin.com/download.html).

## Ecosystem

Core components of this repository: Webmin, Apache, Docker
...
This repository install way is Package isntallation, you can  view the version from [Official URL](https://webmin.com/index.html).  
We will check [Release version](https://github.com/Websoft9/ansible-webmin/releases) regularly. Update and test this project to ensure that users can successfully install the required version of Webmin.
