...
| --- | --- | --- | --- |
| TCP | 80 | HTTP to access Webmin | Required |
| TCP | 443 | HTTPS to access Webmin | Optional |
| TCP | 3306 | Remote to access MySQL | Optional |
| TCP | 9003 | Use port to access Webmin | Optional |
| TCP | 9002 | Webmin Document Server on Docker | Optional |
